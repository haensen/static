export default [
    ...
    },
    {
        ...
        planets: [
            { x: 0.2, y: 0.2, weight: 5.0, image: 'planet1', radius: 60 },
            { x: 0.2, y: 0.8, weight: 5.0, image: 'planet2', radius: 60 },
            { x: 0.5, y: 0.2, weight: 5.0, image: 'planet3', radius: 60 },
            { x: 0.5, y: 0.8, weight: 5.0, image: 'planet4', radius: 60 },
            { x: 0.7, y: 0.2, weight: 5.0, image: 'planet5', radius: 60 },
            { x: 0.8, y: 0.8, weight: 5.0, image: 'planet6', radius: 60 },
        ],
        texts: []
    },
    {
